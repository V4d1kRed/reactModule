...
function MUISwitch(props) {
  ...
  const handleClickThemeSwitch = () => dispatch(toggleTheme());

  return (
    <SwitchRoot checked={true} className={clsx(stateClasses)} onClick={handleClickThemeSwitch}>
      <SwitchTrack>
...
export default function ThemeSwitch() {
  ...
  return <MUISwitch checked={theme === 'light' ? false : true}/>;
}
